...
// as one big header; defining VMA_IMPLEMENTATION in exactly one .cpp emits its function bodies
// here, and every other TU includes the header for declarations only. This file is built in its own
