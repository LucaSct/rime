...
// Fold every body's raw state bytes into one FNV-1a hash, in id order (the M7.1 determinism
// witness, reused: BodyState is zero-initialized first so padding bytes hash deterministically).
